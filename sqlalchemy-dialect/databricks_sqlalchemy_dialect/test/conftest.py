...
registry.register("databricks", "databricks_sqlalchemy_dialect", "DatabricksDialect")
...
registry.register("databricks.databricks", "databricks_sqlalchemy_dialect", "DatabricksDialect")
